...
`,[$("splitor",`
 ...
 position: relative;
 fill: currentColor;
`,[C("color-transition",{transition:"color .3s var(--n-bezier)"}),C("depth",{color:"var(--n-color)"},[A("svg",{opacity:"var(--n-opacity)",transition:"opacity .3s var(--n-bezier)"})]),A("svg",{height:"1em",width:"1em"})]),uo=Object.assign(Object.assign({},Y.props),{depth:[String,Number],size:[Number,String],color:String,component:[Object,Function]}),co=U({_n_icon__:!0,name:"Icon",inheritAttrs:!1,props:uo,setup(e){const{mergedClsPrefixRef:o,inlineThemeDisabled:r}=ie(e),i=Y("Icon","-icon",so,Ae,e,o),t=x(()=>{const{depth:d}=e,{common:{cubicBezierEaseInOut:l},self:a}=i.value;if(d!==void 0){const{color:v,[`opacity${d}Depth`]:f}=a;return{"--n-bezier":l,"--n-color":v,"--n-opacity":f}}return{"--n-bezier":l,"--n-color":"","--n-opacity":""}}),n=r?ce("icon",x(()=>`${e.depth||"d"}`),t,e):void 0;return{mergedClsPrefix:o,mergedStyle:x(()=>{const{size:d,color:l}=e;return{fontSize:je(d),color:l}}),cssVars:r?void 0:t,themeClass:n?.themeClass,onRender:n?.onRender}},render(){var e;const{$parent:o,depth:r,mergedClsPrefix:i,component:t,onRender:n,themeClass:d}=this;return!((e=o?.$options)===null||e===void 0)&&e._n_icon__&&ge("icon","don't wrap `n-icon` inside `n-icon`"),n?.(),s("i",fe(this.$attrs,{role:"img",class:[`${i}-icon`,d,{[`${i}-icon--depth`]:r,[`${i}-icon--color-transition`]:r!==void 0}],style:[this.cssVars,this.mergedStyle]}),t?s(t):this.$slots)}});function le(e,o){return e.type==="submenu"||e.type===void 0&&e[o]!==void 0}function fo(e){return e.type==="group"}function Re(e){return e.type==="divider"}function po(e){return e.type==="render"}const ke=U({name:"DropdownOption",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null},placement:{type:String,default:"right-start"},props:Object,scrollable:Boolean},setup(e){const o=q(ae),{hoverKeyRef:r,keyboardKeyRef:i,lastToggledSubmenuKeyRef:t,pendingKeyPathRef:n,activeKeyPathRef:d,animatedRef:l,mergedShowRef:a,renderLabelRef:v,renderIconRef:f,labelFieldRef:R,childrenFieldRef:g,renderOptionRef:P,nodePropsRef:N,menuPropsRef:D}=o,k=q(ve,null),K=q(pe),b=q(me),_=x(()=>e.tmNode.rawNode),S=x(()=>{const{value:c}=g;return le(e.tmNode.rawNode,c)}),z=x(()=>{const{disabled:c}=e.tmNode;return c}),B=x(()=>{if(!S.value)return!1;const{key:c,disabled:w}=e.tmNode;if(w)return!1;const{value:j}=r,{value:V}=i,{value:de}=t,{value:J}=n;return j!==null?J.includes(c):V!==null?J.includes(c)&&J[J.length-1]!==c:de!==null?J.includes(c):!1}),M=x(()=>i.value===null&&!l.value),X=oo(B,300,M),H=x(()=>!!k?.enteringSubmenuRef.value),G=O(!1);Q(ve,{enteringSubmenuRef:G});function E(){G.value=!0}function u(){G.value=!1}function m(){const{parentKey:c,tmNode:w}=e;w.disabled||a.value&&(t.value=c,i.value=null,r.value=w.key)}function h(){const{tmNode:c}=e;c.disabled||a.value&&r.value!==c.key&&m()}function p(c){if(e.tmNode.disabled||!a.value)return;const{relatedTarget:w}=c;w&&!he({target:w},"dropdownOption")&&!he({target:w},"scrollbarRail")&&(r.value=null)}function F(){const{value:c}=S,{tmNode:w}=e;a.value&&!c&&!w.disabled&&(o.doSelect(w.key,w.rawNode),o.doUpdateShow(!1))}return{labelField:R,renderLabel:v,renderIcon:f,siblingHasIcon:K.showIconRef,siblingHasSubmenu:K.hasSubmenuRef,menuProps:D,popoverBody:b,animated:l,mergedShowSubmenu:x(()=>X.value&&!H.value),rawNode:_,hasSubmenu:S,pending:Z(()=>{const{value:c}=n,{key:w}=e.tmNode;return c.includes(w)}),childActive:Z(()=>{const{value:c}=d,{key:w}=e.tmNode,j=c.findIndex(V=>w===V);return j===-1?!1:j<c.length-1}),active:Z(()=>{const{value:c}=d,{key:w}=e.tmNode,j=c.findIndex(V=>w===V);return j===-1?!1:j===c.length-1}),mergedDisabled:z,renderOption:P,nodeProps:N,handleClick:F,handleMouseMove:h,handleMouseEnter:m,handleMouseLeave:p,handleSubmenuBeforeEnter:E,handleSubmenuAfterEnter:u}},render(){var e,o;const{animated:r,rawNode:i,mergedShowSubmenu:t,clsPrefix:n,siblingHasIcon:d,siblingHasSubmenu:l,renderLabel:a,renderIcon:v,renderOption:f,nodeProps:R,props:g,scrollable:P}=this;let N=null;if(t){const b=(e=this.menuProps)===null||e===void 0?void 0:e.call(this,i,i.children);N=s(Se,Object.assign({},b,{clsPrefix:n,scrollable:this.scrollable,tmNodes:this.tmNode.children,parentKey:this.tmNode.key}))}const D={class:[`${n}-dropdown-option-body`,this.pending&&`${n}-dropdown-option-body--pending`,this.active&&`${n}-dropdown-option-body--active`,this.childActive&&`${n}-dropdown-option-body--child-active`,this.mergedDisabled&&`${n}-dropdown-option-body--disabled`],onMousemove:this.handleMouseMove,onMouseenter:this.handleMouseEnter,onMouseleave:this.handleMouseLeave,onClick:this.handleClick},k=R?.(i),K=s("div",Object.assign({class:[`${n}-dropdown-option`,k?.class],"data-dropdown-option":!0},k),s("div",fe(D,g),[s("div",{class:[`${n}-dropdown-option-body__prefix`,d&&`${n}-dropdown-option-body__prefix--show-icon`]},[v?v(i):te(i.icon)]),s("div",{"data-dropdown-option":!0,class:`${n}-dropdown-option-body__label`},a?a(i):te((o=i[this.labelField])!==null&&o!==void 0?o:i.title)),s("div",{"data-dropdown-option":!0,class:[`${n}-dropdown-option-body__suffix`,l&&`${n}-dropdown-option-body__suffix--has-submenu`]},this.hasSubmenu?s(co,null,{default:()=>s(to,null)}):null)]),this.hasSubmenu?s(Ee,null,{default:()=>[s(Ue,null,{default:()=>s("div",{class:`${n}-dropdown-offset-container`},s(Ve,{show:this.mergedShowSubmenu,placement:this.placement,to:P&&this.popoverBody||void 0,teleportDisabled:!P},{default:()=>s("div",{class:`${n}-dropdown-menu-wrapper`},r?s(Le,{onBeforeEnter:this.handleSubmenuBeforeEnter,onAfterEnter:this.handleSubmenuAfterEnter,name:"fade-in-scale-up-transition",appear:!0},{default:()=>N}):N)}))})]}):null);return f?f({node:K,option:i}):K}}),ho=U({name:"NDropdownGroup",props:{clsPrefix:{type:String,required:!0},tmNode:{type:Object,required:!0},parentKey:{type:[String,Number],default:null}},render(){const{tmNode:e,parentKey:o,clsPrefix:r}=this,{children:i}=e;return s(Me,null,s(lo,{clsPrefix:r,tmNode:e,key:e.key}),i?.map(t=>{const{rawNode:n}=t;return n.show===!1?null:Re(n)?s(xe,{clsPrefix:r,key:t.key}):t.isGroup?(ge("dropdown","`group` node is not allowed to be put in `group` node."),null):s(ke,{clsPrefix:r,tmNode:t,parentKey:o,key:t.key})}))}}),vo=U({name:"DropdownRenderOption",props:{tmNode:{type:Object,required:!0}},render(){const{rawNode:{render:e,props:o}}=this.tmNode;return s("div",o,[e?.()])}}),Se=U({name:"DropdownMenu",props:{scrollable:Boolean,showArrow:Boolean,arrowStyle:[String,Object],clsPrefix:{type:String,required:!0},tmNodes:{type:Array,default:()=>[]},parentKey:{type:[String,Number],default:null}},setup(e){const{renderIconRef:o,childrenFieldRef:r}=q(ae);Q(pe,{showIconRef:x(()=>{const t=o.value;return e.tmNodes.some(n=>{var d;if(n.isGroup)return(d=n.children)===null||d===void 0?void 0:d.some(({rawNode:a})=>t?t(a):a.icon);const{rawNode:l}=n;return t?t(l):l.icon})}),hasSubmenuRef:x(()=>{const{value:t}=r;return e.tmNodes.some(n=>{var d;if(n.isGroup)return(d=n.children)===null||d===void 0?void 0:d.some(({rawNode:a})=>le(a,t));const{rawNode:l}=n;return le(l,t)})})});const i=O(null);return Q(qe,null),Q(We,null),Q(me,i),{bodyRef:i}},render(){const{parentKey:e,clsPrefix:o,scrollable:r}=this,i=this.tmNodes.map(t=>{const{rawNode:n}=t;return n.show===!1?null:po(n)?s(vo,{tmNode:t,key:t.key}):Re(n)?s(xe,{clsPrefix:o,key:t.key}):fo(n)?s(ho,{clsPrefix:o,tmNode:t,parentKey:e,key:t.key}):s(ke,{clsPrefix:o,tmNode:t,parentKey:e,key:t.key,props:n.props,scrollable:r})});return s("div",{class:[`${o}-dropdown-menu`,r&&`${o}-dropdown-menu--scrollable`],ref:"bodyRef"},r?s(He,{contentClass:`${o}-dropdown-menu__content`},{default:()=>i}):i,this.showArrow?Ge({clsPrefix:o,arrowStyle:this.arrowStyle,arrowClass:void 0,arrowWrapperClass:void 0,arrowWrapperStyle:void 0}):null)}}),bo=I("dropdown-menu",`
